...
from .views import view_subjects, create_subject, update_subject, update_all_textbooks, update_all_web_materials, delete_textbooks
...
urlpatterns = [
    ...
    path('delete_textbooks/<int:subject_id>/', delete_textbooks, name='delete_textbooks')
]
